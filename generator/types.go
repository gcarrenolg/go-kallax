...
var specialTypes = map[string]string{
	"github.com/gcarrenolg/go-kallax.UUID":      "kallax.UUID",
	"github.com/gcarrenolg/go-kallax.ULID":      "kallax.ULID",
	"github.com/gcarrenolg/go-kallax.NumericID": "kallax.NumericID",
