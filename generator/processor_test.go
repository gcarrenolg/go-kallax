...
func TestRemoveGoPath(t *testing.T) {
	...
	cases := []struct {
		...
		{
			`E:\workspace\gopath\src\github.com\gcarrenolg\go-kallax\tests\fixtures.AliasString`,
			"github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			[]string{
				`E:\workspace\gopath`,
			},
			'\\',
		...
		{
			"/home/workspace/gopath/src/github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			"github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
		...
		{
			"/home/workspace/gopath/src/foo/bar/vendor/github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			"github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
				"/home/workspace/gopath",
		...
		{
			"/home/vendor/workspace/gopath/src/github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			"github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
		...
		{
			"/home/vendor/workspace/gopath/src/vendor/github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			"github.com/gcarrenolg/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
				"/home/vendor/workspace/gopath",
